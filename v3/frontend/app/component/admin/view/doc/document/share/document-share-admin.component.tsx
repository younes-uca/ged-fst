            ...
            <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
                <TabPanel header={t("document.tabPan")}>
                    <div className="flex flex-column gap-2 px-3">
                        <p className="mt-3">
                            This is a temporary URL with integrated access credentials for sharing
                            objects valid for up to 7 days.
                        </p>
                        <p>The temporary URL expires after the configured time limit.</p>
                        <h6>Active for:</h6>
                        <div className="flex align-items-center justify-content-between px-8">
                            <InputTime
                                text="Days"
                        ...
                        <TabPanel header="Creation">
                            <div className="grid">
                                ...
                                <div className="field col-6">
                                    ...
                                    <InputText id="description" value={documentPartageGroupes.description}
                        ...
                        <TabPanel header="Creation">
                            <div className="grid">
                                ...
                                <div className="field col-6">
                                    ...
                                    <InputText id="description" value={documentPartageUtilisateurs.description}
