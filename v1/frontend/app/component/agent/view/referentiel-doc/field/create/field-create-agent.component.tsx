...
const Create: React.FC<FieldCreateAgentType> = ({visible, onClose, add, showToast, list, service, t}) => {
    ...
    const emptyItem = new FieldDto();
        const {
            ...
            saveItem,
            formateDate
        } = useCreateHook<FieldDto, FieldCriteria>({list, emptyItem, onClose, add, showToast,service})
