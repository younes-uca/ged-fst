...
const Create: React.FC<DocumentFieldStateCreateAdminType> = ({visible, onClose, add, showToast, list, service, t}) => {
    ...
    const emptyItem = new DocumentFieldStateDto();
        const {
            ...
            saveItem,
            formateDate
        } = useCreateHook<DocumentFieldStateDto, DocumentFieldStateCriteria>({list, emptyItem, onClose, add, showToast,service})
