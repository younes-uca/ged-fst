...
const List = () => {
    ...
    const emptyCriteria = new FieldCriteria();
    const service = new FieldAdminService();
    ...
    const {
        ...
        statusBodyTemplate,
        formateDate
    } = useListHook<FieldDto, FieldCriteria>({ emptyItem, emptyCriteria,service, t})
        ...
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as FieldDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    ...
                    <Column field="code" header={t("field.code")} sortable></Column>
                    
                    
                    <Column field="libelle" header={t("field.libelle")} sortable></Column>
