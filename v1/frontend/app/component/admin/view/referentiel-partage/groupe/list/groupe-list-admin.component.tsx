                    ...
                    <div className="search-container">
                        <div className="grid">
                            <span className="p-float-label mr-3 align-search-items mt-4">
                                ...
                                <label htmlFor="1">{t("groupe.code")}</label>
                            </span>
                            <span className="p-float-label mr-3 align-search-items mt-4">
                                <InputText id="2" value={criteria.libelle} onChange={(e) => setCriteria({ ...criteria, libelle: e.target.value })} />
                                <label htmlFor="2">{t("groupe.libelle")}</label>
                            </span>
                            <span className="mr-3 align-search-items mt-4">
                                <Dropdown id="3" value={criteria.utilisateur} options={utilisateurs} onChange={(e) => setCriteria({ ...criteria, utilisateur: e.target.value })} optionLabel="nom" filter showClear placeholder={t("groupe.utilisateurPlaceHolder")} filterPlaceholder={t("groupe.utilisateurPlaceHolderFilter")} />
                            </span>
                        </div>
