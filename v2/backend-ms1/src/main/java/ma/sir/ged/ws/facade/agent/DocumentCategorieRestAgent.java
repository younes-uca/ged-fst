...
@RestController
@RequestMapping("/api/agent/documentCategorie/")
public class DocumentCategorieRestAgent  extends AbstractController<DocumentCategorie, DocumentCategorieDto, DocumentCategorieHistory, DocumentCategorieCriteria, DocumentCategorieHistoryCriteria, DocumentCategorieAgentService, DocumentCategorieConverter> {
    ...
    public DocumentCategorieRestAgent (DocumentCategorieAgentService service, DocumentCategorieConverter converter) {
