...
--
-- Structure de la table `fichier_version`
--

CREATE TABLE `fichier_version` (
  `version_id` varchar(100) NOT NULL,
  `version_number` int(11) NOT NULL,
  `fichier_id` bigint(20) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Index pour la table `fichier_version`
--
ALTER TABLE `fichier_version`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `FKeher7s4o3qi6cuqq2cfbtfe8a` (`fichier_id`);
