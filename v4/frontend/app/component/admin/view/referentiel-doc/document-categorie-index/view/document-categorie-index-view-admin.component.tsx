...
type DocumentCategorieIndexViewAdminType = {
    visible: boolean,
    onClose: () => void,
...
const View: React.FC<DocumentCategorieIndexViewAdminType> = ({visible,onClose,selectedItem, t}) => {
    ...
    adaptDate,
    activeIndex
    } = useViewHook<DocumentCategorieIndexDto>({selectedItem, onClose})
