...
const Create: React.FC<DocumentCreateAdminType> = ({visible, onClose, add, showToast, list, service, t}) => {
    ...
    const onUpload = (event: any) => {
        const entiteAdministrative = "compta";
        const user = "younes"
    ...
    return (
        <Dialog visible={visible} style={{width: '70vw'}} header={t("document.tabPan")} modal className="p-fluid"
            ...
            <TabView activeIndex={activeIndex} onTabChange={onTabChange}>
                <TabPanel header={t("document.tabPan")}>
                    <div className="formgrid grid">
                        ...
                        <div className="field col-6">
                            <FileUpload accept=".pdf,.jpg,.png" chooseLabel="Choose File" uploadLabel="Upload"
                                        name="file" customUpload uploadHandler={onUpload}/>
                        </div>
                        <div className="field col-6">
                        ...
                        <div className="field col-6">
                            ...
                            <InputNumber id="annee" value={item.annee}
                                         onChange={(e) => onInputNumerChange(e, 'annee')}/>
                        </div>
                        <div className="field col-6">
                            <label htmlFor="semstre">{t("document.semstre")}</label>
                            <InputNumber id="semstre" value={item.semstre}
                                         onChange={(e) => onInputNumerChange(e, 'semstre')}/>
                        </div>
                        <div className="field col-6">
                        ...
                        <InputTextarea id="content" value={item.content}
                                       onChange={(e) => onInputTextChange(e, 'content')} rows={5} cols={30}/>
                    </span>
                        </div>
                        <div className="field col-6">
                        ...
                        <div className="field col-6">
                            ...
                            <Dropdown id="documentCategorieModelDropdown" value={item.documentCategorieModel}
                                      options={documentCategorieModels}
                                      onChange={(e) => onDropdownChange(e, 'documentCategorieModel')}
                                      placeholder={t("document.documentCategorieModelPlaceHolder")} filter
                ...
                <TabPanel header={t("document.documentIndexElements")}>
                    <div className="grid">
                        ...
                        <div className="field col-6">
                            ...
                            <InputText id="value" value={documentIndexElements.value}
                                       onChange={(e) => onInputTextChangeDocumentIndexElements(e, 'value')} required
                        ...
                        <div className="field col-6">
                            ...
                            <span className="p-float-label">
                                    <InputTextarea id="description" value={item ? item.documentIndexElements : ''}
                            ...
                            <DataTable value={item.documentIndexElements} tableStyle={{minWidth: '50rem'}} dataKey="id">
                                ...
                                <Column header={t("actions")} body={(rowData) => (<div>
                                    ...
                                    <Button icon="pi pi-pencil" rounded severity="success" className="mr-2"
                                            onClick={() => editDocumentIndexElements(rowData)}/></div>)}></Column>
                            </DataTable>
                        </div>
                    </div>
                </TabPanel>
                <TabPanel header={t("document.documentPartageGroupes")}>
                    <div className="grid">
                        <div className="field col-6">
                            ...
                            <Dropdown id="groupeDropdown" value={documentPartageGroupes.groupe} options={groupes}
                                      onChange={(e) => onDropdownChangeDocumentPartageGroupes(e, 'groupe')}
                                      placeholder={t("documentPartageGroupe.groupePlaceHolder")} filter
                                      filterPlaceholder={t("documentPartageGroupe.groupePlaceHolderFilter")}
                                      optionLabel="libelle" showClear/>
                        </div>
                        <div className="field col-6">
                        ...
                        <div className="field col-6">
                            ...
                            <Dropdown id="accessShareDropdown" value={documentPartageGroupes.accessShare}
                                      ...
                                      placeholder={t("documentPartageGroupe.accessSharePlaceHolder")} filter
                                      filterPlaceholder={t("documentPartageGroupe.accessSharePlaceHolderFilter")}
                                      optionLabel="libelle" showClear/>
                        </div>
                        <div className="field col-6">
                            <label htmlFor="description">{t("documentPartageGroupe.description")}</label>
                            <span className="p-float-label">
                                    <InputTextarea id="description" value={item ? item.documentPartageGroupes : ''}
                                                   onChange={(e) => onInputTextChange(e, 'description')} rows={5}
                                                   cols={30}/>
                                </span>
                        </div>
                    ...
                    <div className="grid">
                        <div className="field col-6">
                            ...
                            <Dropdown id="utilisateurDropdown" value={documentPartageUtilisateurs.utilisateur}
                                      ...
                                      placeholder={t("documentPartageUtilisateur.utilisateurPlaceHolder")} filter
                                      filterPlaceholder={t("documentPartageUtilisateur.utilisateurPlaceHolderFilter")}
                        ...
                        <div className="field col-6">
                            ...
                            <Dropdown id="accessShareDropdown" value={documentPartageUtilisateurs.accessShare}
                                      ...
                                      placeholder={t("documentPartageUtilisateur.accessSharePlaceHolder")} filter
                                      filterPlaceholder={t("documentPartageUtilisateur.accessSharePlaceHolderFilter")}
                                      optionLabel="libelle" showClear/>
                        </div>
                        <div className="field col-6">
                            <label htmlFor="description">{t("documentPartageUtilisateur.description")}</label>
                            <span className="p-float-label">
                                    <InputTextarea id="description" value={item ? item.documentPartageUtilisateurs : ''}
                                                   onChange={(e) => onInputTextChange(e, 'description')} rows={5}
                                                   cols={30}/>
                                </span>
                        </div>
                        ...
                        <div className="card">
                            <DataTable value={item.documentPartageUtilisateurs} tableStyle={{minWidth: '50rem'}}
                                ...
                                <Column header={t("actions")} body={(rowData) => (<div>
                                    ...
                                    <Button icon="pi pi-pencil" rounded severity="success" className="mr-2"
                                            onClick={() => editDocumentPartageUtilisateurs(rowData)}/></div>)}></Column>
                            </DataTable>
                        </div>
                    </div>
                </TabPanel>
