...
type EntiteAdministrativeTypeCreateCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const Create: React.FC<EntiteAdministrativeTypeCreateCollaborateurType> = ({visible, onClose, add, showToast, list, service, t}) => {
