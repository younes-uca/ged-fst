...
type EntiteAdministrativeTypeViewCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const View: React.FC<EntiteAdministrativeTypeViewCollaborateurType> = ({visible,onClose,selectedItem, t}) => {
    ...
    adaptDate,
    activeIndex
    } = useViewHook<EntiteAdministrativeTypeDto>({selectedItem, onClose})
