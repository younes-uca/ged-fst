...
import Edit from '../edit/entite-administrative-type-edit-collaborateur.component';
import Create from '../create/entite-administrative-type-create-collaborateur.component';
import View from '../view/entite-administrative-type-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new EntiteAdministrativeTypeCollaborateurService();
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
        <h5 className="m-0">{t("entiteAdministrativeType.header")}</h5>
        ...
        <div className="col-12">
            <div className="card">
                ...
                <Dialog visible={deleteItemDialog} style={{width: '450px'}} header={t("confirm")} modal footer={deleteItemDialogFooter} onHide={hideDeleteItemDialog}>
                    ...
                    {item && (<span>{t("entiteAdministrativeType.deleteEntiteAdministrativeTypeConfirmationMessage")} <b>{item.libelle}</b>?</span>)}
                    </div>
                </Dialog>
