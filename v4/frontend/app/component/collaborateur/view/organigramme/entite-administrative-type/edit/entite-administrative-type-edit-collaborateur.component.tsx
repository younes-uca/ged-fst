...
type EntiteAdministrativeTypeEditCollaborateurType = {
    visible: boolean,
    onClose: () => void,
    ...
    service: EntiteAdministrativeTypeCollaborateurService,
    t: TFunction
}
const Edit: React.FC<EntiteAdministrativeTypeEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
