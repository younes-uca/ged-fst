...
import Edit from '../edit/utilisateur-edit-collaborateur.component';
import Create from '../create/utilisateur-create-collaborateur.component';
import View from '../view/utilisateur-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new UtilisateurCollaborateurService();
