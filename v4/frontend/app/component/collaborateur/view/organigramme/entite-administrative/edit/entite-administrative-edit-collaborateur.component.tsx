...
type EntiteAdministrativeEditCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const Edit: React.FC<EntiteAdministrativeEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
