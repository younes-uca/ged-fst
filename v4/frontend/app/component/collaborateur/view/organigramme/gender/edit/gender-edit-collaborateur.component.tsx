...
type GenderEditCollaborateurType = {
    visible: boolean,
    onClose: () => void,
    ...
    list: GenderDto[],
    service: GenderCollaborateurService,
    t: TFunction
}
const Edit: React.FC<GenderEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
