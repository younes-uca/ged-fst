...
import Edit from '../edit/gender-edit-collaborateur.component';
import Create from '../create/gender-create-collaborateur.component';
import View from '../view/gender-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new GenderCollaborateurService();
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
        <h5 className="m-0">{t("gender.header")}</h5>
        ...
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as GenderDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    ...
                    <Column field="code" header={t("gender.code")} sortable></Column>
                ...
                <Dialog visible={deleteItemDialog} style={{width: '450px'}} header={t("confirm")} modal footer={deleteItemDialogFooter} onHide={hideDeleteItemDialog}>
                    ...
                    {item && (<span>{t("gender.deleteGenderConfirmationMessage")} <b>{item.libelle}</b>?</span>)}
                    </div>
                </Dialog>
