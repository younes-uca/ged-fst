...
type DocumentTypeViewCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const View: React.FC<DocumentTypeViewCollaborateurType> = ({visible,onClose,selectedItem, t}) => {
    ...
    adaptDate,
    activeIndex
    } = useViewHook<DocumentTypeDto>({selectedItem, onClose})
