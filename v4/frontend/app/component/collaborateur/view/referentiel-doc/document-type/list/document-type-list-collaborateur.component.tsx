...
import Edit from '../edit/document-type-edit-collaborateur.component';
import Create from '../create/document-type-create-collaborateur.component';
import View from '../view/document-type-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new DocumentTypeCollaborateurService();
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
        <h5 className="m-0">{t("documentType.header")}</h5>
        ...
        <div className="col-12">
            <div className="card">
                ...
                <Dialog visible={deleteItemDialog} style={{width: '450px'}} header={t("confirm")} modal footer={deleteItemDialogFooter} onHide={hideDeleteItemDialog}>
                    ...
                    {item && (<span>{t("documentType.deleteDocumentTypeConfirmationMessage")} <b>{item.libelle}</b>?</span>)}
                    </div>
                </Dialog>
