...
type TagEditCollaborateurType = {
    ...
    list: TagDto[],
    service: TagCollaborateurService,
    t: TFunction
}
const Edit: React.FC<TagEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
