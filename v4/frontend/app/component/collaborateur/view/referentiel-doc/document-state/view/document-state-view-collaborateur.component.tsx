...
type DocumentStateViewCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const View: React.FC<DocumentStateViewCollaborateurType> = ({visible,onClose,selectedItem, t}) => {
    ...
    adaptDate,
    activeIndex
    } = useViewHook<DocumentStateDto>({selectedItem, onClose})
