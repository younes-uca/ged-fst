...
type DocumentStateEditCollaborateurType = {
    visible: boolean,
    onClose: () => void,
    ...
    service: DocumentStateCollaborateurService,
    t: TFunction
}
const Edit: React.FC<DocumentStateEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
