...
import Edit from '../edit/document-state-edit-collaborateur.component';
import Create from '../create/document-state-create-collaborateur.component';
import View from '../view/document-state-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new DocumentStateCollaborateurService();
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
        <h5 className="m-0">{t("documentState.header")}</h5>
