...
type EtatUtilisateurEditCollaborateurType = {
    visible: boolean,
    onClose: () => void,
    ...
    service: EtatUtilisateurCollaborateurService,
    t: TFunction
}
const Edit: React.FC<EtatUtilisateurEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
