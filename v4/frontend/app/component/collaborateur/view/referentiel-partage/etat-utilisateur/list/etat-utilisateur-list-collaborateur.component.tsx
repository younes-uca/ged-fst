...
import Edit from '../edit/etat-utilisateur-edit-collaborateur.component';
import Create from '../create/etat-utilisateur-create-collaborateur.component';
import View from '../view/etat-utilisateur-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new EtatUtilisateurCollaborateurService();
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
        <h5 className="m-0">{t("etatUtilisateur.header")}</h5>
        ...
        <div className="col-12">
            <div className="card">
                ...
                <Dialog visible={deleteItemDialog} style={{width: '450px'}} header={t("confirm")} modal footer={deleteItemDialogFooter} onHide={hideDeleteItemDialog}>
                    ...
                    {item && (<span>{t("etatUtilisateur.deleteEtatUtilisateurConfirmationMessage")} <b>{item.libelle}</b>?</span>)}
                    </div>
                </Dialog>
            ...
            <Dialog visible={deleteItemsDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteItemsDialogFooter} onHide={hideDeleteItemsDialog} >
                <div className="flex align-items-center justify-content-center">
                    <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                    {item && <span>{t("etatUtilisateur.deleteEtatUtilisateursConfirmationMessage")}</span>}
                </div>
            </Dialog>
