...
type EtatUtilisateurViewCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const View: React.FC<EtatUtilisateurViewCollaborateurType> = ({visible,onClose,selectedItem, t}) => {
    ...
    adaptDate,
    activeIndex
    } = useViewHook<EtatUtilisateurDto>({selectedItem, onClose})
