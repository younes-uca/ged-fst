...
import Edit from '../edit/role-utilisateur-edit-collaborateur.component';
import Create from '../create/role-utilisateur-create-collaborateur.component';
import View from '../view/role-utilisateur-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new RoleUtilisateurCollaborateurService();
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
        <h5 className="m-0">{t("roleUtilisateur.header")}</h5>
    ...
    <div className="grid crud-demo">
        <div className="col-12">
            <div className="card">
                ...
                <Card title={t("search")} className="mb-5">
                        <div className="grid">
                            ...
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="3">{t("roleUtilisateur.description")}</label>
                ...
                <Dialog visible={deleteItemDialog} style={{width: '450px'}} header={t("confirm")} modal footer={deleteItemDialogFooter} onHide={hideDeleteItemDialog}>
                    ...
                    {item && (<span>{t("roleUtilisateur.deleteRoleUtilisateurConfirmationMessage")} <b>{item.libelle}</b>?</span>)}
                    </div>
                </Dialog>
            ...
            <Dialog visible={deleteItemsDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteItemsDialogFooter} onHide={hideDeleteItemsDialog} >
                <div className="flex align-items-center justify-content-center">
                    <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                    {item && <span>{t("roleUtilisateur.deleteRoleUtilisateursConfirmationMessage")}</span>}
                </div>
            </Dialog>
