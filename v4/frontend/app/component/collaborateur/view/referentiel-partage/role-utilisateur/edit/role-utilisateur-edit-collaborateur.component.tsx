...
type RoleUtilisateurEditCollaborateurType = {
    visible: boolean,
    onClose: () => void,
    ...
    service: RoleUtilisateurCollaborateurService,
    t: TFunction
}
const Edit: React.FC<RoleUtilisateurEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
