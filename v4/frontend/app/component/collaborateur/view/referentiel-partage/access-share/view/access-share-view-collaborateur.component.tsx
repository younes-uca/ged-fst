...
type AccessShareViewCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const View: React.FC<AccessShareViewCollaborateurType> = ({visible,onClose,selectedItem, t}) => {
    ...
    adaptDate,
    activeIndex
    } = useViewHook<AccessShareDto>({selectedItem, onClose})
