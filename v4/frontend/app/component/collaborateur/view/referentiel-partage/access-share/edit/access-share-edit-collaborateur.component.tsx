...
type AccessShareEditCollaborateurType = {
    visible: boolean,
    onClose: () => void,
    ...
    list: AccessShareDto[],
    service: AccessShareCollaborateurService,
    t: TFunction
}
const Edit: React.FC<AccessShareEditCollaborateurType> = ({visible, onClose, showToast, selectedItem, update, list, service, t}) => {
