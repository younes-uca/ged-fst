...
type GroupeViewCollaborateurType = {
    visible: boolean,
    onClose: () => void,
...
const View: React.FC<GroupeViewCollaborateurType> = ({visible,onClose,selectedItem, t}) => {
    ...
    adaptDate,
    activeIndex
    } = useViewHook<GroupeDto>({selectedItem, onClose})
