...
import Edit from '../edit/document-edit-collaborateur.component';
import Create from '../create/document-create-collaborateur.component';
import View from '../view/document-view-collaborateur.component';
...
const List = () => {
    ...
    const service = new DocumentCollaborateurService();
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
        <h5 className="m-0">{t("document.header")}</h5>
